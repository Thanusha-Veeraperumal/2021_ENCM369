...
void UserAppRun(void)
{
    ...
    u16 au16MusicNotes[] = {(u16)(u16)60, (u16)(u16)60, (u16)(u16)40, (u16)(u16)40, (u16)(u16)36, (u16)(u16)36, (u16)(u16)40, (u16)(u16)45, (u16)(u16)45, (u16)(u16)47, (u16)(u16)47, (u16)(u16)53, (u16)(u16)53, (u16)(u16)60};
    u16 au16NoteDurations[] = {(u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 2), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 4), (u16)((u16)2048 / 2)};


    if(u16TimeCounter < au16NoteDurations[u8NoteIndex])
    {
        InterruptTimerXus(au16MusicNotes[u8NoteIndex], 1);
        u16TimeCounter++;
    }
    ...
    else
    {
        ...
        for(u16TimeCounter = 0; u16TimeCounter < (u16)50; u16TimeCounter++)
        {
            InterruptTimerXus((u16)(u16)0, 1);
        }

        u8NoteIndex++;
        if (u8NoteIndex == sizeof(au16MusicNotes)/sizeof(au16MusicNotes[0]))
        {
            u8NoteIndex = 0;
        }
    }
